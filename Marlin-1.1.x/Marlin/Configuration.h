...
#define STRING_CONFIG_H_AUTHOR "Cristian A" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //Flyingbear Ghost
  #define DEFAULT_bedKp 12.89
  #define DEFAULT_bedKi 2.46
  #define DEFAULT_bedKd 45.07
 ...
 * stepper drivers that suppo
 * TMC2208 software UART and ENDSTOP_INTERRUPTS both use pin crt them. You may also override timing options in Configuration_adv.h.
 *
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 394, 94 }
